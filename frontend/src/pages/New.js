...
export default class New extends Component
{
    ...
    handleSubmit = async e =>
    {
        ...
        this.props.history.push('/') // similar ao this.props.navigation.navigate
    }
    render()
    {
        return (
            <form id="new-post" onSubmit={this.handleSubmit}>
                ...
                <input type="text" name="author" placeholder="Author do post" onChange={this.handleChange} value={this.state.author} />
